	...
	public static void main(String[] args) {
		...
		try {
			...
			if (employeeFirstName.isBlank()) {
				/**
				 * If first name is blank then throwing user defined exception with appropriate
				 * message.
				 */
				throw new NameException("First name can't be blank");
			}
			/**
			 * After validating the first name if there is no problem then taking the last
			 ...
			 */
				...
				if (employeeLastName.isBlank()) {
					/**
					 * If last name is blank then throwing user defined exception with appropriate
					 * message.
					 */
